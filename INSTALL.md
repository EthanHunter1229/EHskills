...
- [SKILL.md](./formal-report-formatting/SKILL.md) - Skill 完整定义
- [formatting_rules.md](./formal-report-formatting/references/formatting_rules.md) - 排版规范详解
- [llm_vs_regex.md](./formal-report-formatting/references/llm_vs_regex.md) - LLM vs 正则技术对比
- [IMPROVEMENT_SUMMARY.md](./IMPROVEMENT_SUMMARY.md) - 设计演进总结
